"""Regression checks for the cobalt-sys-process-index casebook."""
...
from casebook.harness import assert_expected, cobalt_sys_process_index_summary
...
class CasebookTests(unittest.TestCase):
    ...
    def test_named_summary_alias(self) -> None:
        self.assertEqual(cobalt_sys_process_index_summary(), assert_expected())
